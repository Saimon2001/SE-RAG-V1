...
# ---------- Connect ----------
client = weaviate.connect_to_local()  # or connect_to_weaviate(...)
# If you already created collections before, set this to True to drop them:
RESET = False
...
def ensure_schema():
    ...
    # Vectorizer: use what you have available locally; change if needed.
